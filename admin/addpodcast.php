...
<head>
  ...
  <title>Add Podcast | SoundWave</title>
       ...
       <?php include"topbar.php";?>
        ...
        <div class="container-fluid">
		  ...
		  <div class="row">
             ...
             <div class="col-lg-6">
             <h1 class="h3 mb-4 text-gray-800">Create Podcast</h1>
			 <?php
...
$currentDir = getcwd();
 ...
 if (empty($errors)) 
 {
         ...
         VALUES ('$title','$host','$image','$fileName')
					  ");
            ...
            foreach ($errors as $error) {
             ...
             <form class="user" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      <input type="text" class="form-control" name="title" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Podcast Title">
                    </div>
                    
					<div class="form-group">
                      <input type="text" class="form-control" name="host" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Host Name">
                    </div>
